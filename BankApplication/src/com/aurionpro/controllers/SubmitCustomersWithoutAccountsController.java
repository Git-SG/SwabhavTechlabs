...
@WebServlet("/SubmitCustomersWithoutAccountsController")
public class SubmitCustomersWithoutAccountsController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public SubmitCustomersWithoutAccountsController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String customerIDWithoutAccounts = request.getParameter("customerIDWithoutAccounts");
		
		bankDbUtil.connectToDB();
		Customer customer = bankDbUtil.getCustomerById(Integer.parseInt(customerIDWithoutAccounts));
